  ...
  return (
    <div className="w-full h-auto bg-bodyColor text-lightText px-4">
      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <p className="text-base font-bodyFont leading-6 tracking-wide mt-3">
            3.WO2014188440A1, US20160122360, EP3004116, CA2913281,
          IN2013DE01565, Jain, S.K.; Sidiq, T.; Meena, S.; Khajuria, A.;
          Vishwakarma, R.A.; Bharate, S.B. Tetrahydro-2H-pyrano[(3, 2 - C)]
          -isochromene-6-ones and analogs for the treatment of inflammatory
          disorders.  
        </p>
        <p className="text-base font-bodyFont leading-6 tracking-wide mt-3">
        ...
        <p className="text-base font-bodyFont leading-6 tracking-wide mt-3">
            6.Indolylkojyl derivatives as inhibitor of invasion and metastasis
          in human mammary gland carcinomas. 2016 (application number
